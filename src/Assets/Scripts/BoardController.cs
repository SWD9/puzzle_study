...
public class BoardController : MonoBehaviour
{
    ...
    public bool Settle(Vector2Int pos,int val)
    {
        ...
        Vector3 woeld_position = transform.position + new Vector3(pos.x,pos.y,0.0f);
        _Puyos[pos.y, pos.x] = Instantiate(prefabPuyo,woeld_position,Quaternion.identity,transform);
